...
public interface HefeiBusApi {
     ...
     */
    @GET("BusLineHandler.ashx")
    Observable<List<StationData>> getRxStationData(@Query("type") String type, @Query("StationName") String stationName);
     ...
     */
    @GET("BusLineHandler.ashx")
    Observable<List<TransferData>> getRxVehicleTransfer(@Query("type") String type, @Query("StartPointName") String startPointName, @Query("EndPointName") String endPointName);
